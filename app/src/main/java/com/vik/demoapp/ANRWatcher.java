...
/**
 * A timer thread that detects when the UI thread has frozen.
 */
...
public class ANRWatcher extends Thread {
    ...
    /**
     * Constructs a watcher that checks the ui thread every {@value #DEFAULT_ANR_TIMEOUT} milliseconds
     */
    public ANRWatcher() {
    ...
    /**
     * Constructs a watcher that checks the ui thread every given interval
     *
     ...
     */
    public ANRWatcher(int timeoutInterval) {
        super();
        _timeoutInterval = timeoutInterval;
    }

    /**
     * @return The interval of the Watcher
     */
     ...
     */
    public ANRWatcher setANRListener(ANRListener listener) {
        if (listener == null) {
     ...
     * @return itself for chaining.
     */
    public ANRWatcher setANRInterceptor(ANRInterceptor interceptor) {
        if (interceptor == null) {
     ...
     * @return itself for chaining.
     */
    public ANRWatcher setInterruptionListener(InterruptionListener listener) {
        if (listener == null) {
     ...
     * @return itself for chaining.
     */
    public ANRWatcher setReportThreadNamePrefix(String prefix) {
        if (prefix == null) {
            prefix = "";
        }
        _namePrefix = prefix;
     ...
     * @return itself for chaining.
     */
    public ANRWatcher setLogThreadsWithoutStackTrace(boolean logThreadsWithoutStackTrace) {
     ...
     * @return itself for chaining.
     */
    public ANRWatcher setIgnoreDebugger(boolean ignoreDebugger) {
